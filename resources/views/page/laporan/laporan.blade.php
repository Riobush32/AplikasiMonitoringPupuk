        ...
        <thead class="bg-slate-400 border border-black">
            <tr>
                ...
                <th class="border-2 border-black p-2 " rowspan="1" colspan="{{ $totalPupuk+1 }}">Fertilizer
                    ...
                    2023
                    (Kg/palm/year)</th>
                <th class="border-2 border-black p-2 " rowspan="1" colspan="{{ $totalPupuk+1 }}">Fertilizer Requirement
                    2023 (Ton)</th>
            </tr>
            <tr>
        ...
        <tbody class="border-2 border-black text-sm">
            ...
            @endphp
                ...
                <tr>
                    ...
                    <td class="border border-slate-700 text-center px-1">{{ $item->sph }}</td>
            ...
            <tr class="border-2 border-black">
                ...
                @foreach ($dataPcs as $item)
                    @if ($item['divisi'] == $divisi)
                        <th class="border-2 border-black text center px-2">{{ number_format($item['req'], 2) }}</th>
                    @endif
                @endforeach
