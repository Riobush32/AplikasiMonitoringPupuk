...
<dialog id="edit{{ $item->id }}" class="modal">
    <div class="modal-box">
        ...
        <form action="{{ url("/field/$item->id/update") }}" method="POST">
            @csrf @method('PATCH')
            <input type="hidden" class="input input-bordered w-full max-w-xs" name="divisi" value="{{ $divisi }}" />
            ...
            <label class="form-control w-full max-w-xs">
                ...
                <input type="text" placeholder="Type here" class="input input-bordered w-full max-w-xs" name="field_no"
                    value="{{ $item->field_no }}" />
            ...
            <label class="form-control w-full max-w-xs">
                ...
                <input type="text" placeholder="Type here" class="input input-bordered w-full max-w-xs" name="hektar"
                    value="{{ $item->hektar }}" />
            ...
            <label class="form-control w-full max-w-xs">
                ...
                <input type="number" placeholder="Type here" class="input input-bordered w-full max-w-xs" name="treess"
                    value="{{ $item->treess }}" />
