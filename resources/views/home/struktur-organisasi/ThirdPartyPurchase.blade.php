        ...
        <div class="text-center">
            <div class="flex flex-col justify-center items-center">
                ...
                <div class="text-gray-600">
                    <p class="font-bold">Third Party Purchase</p>
                    <p>Department Head</p>
                    <p class="font-semibold">Dodi Ekaprastya</p>
                </div>
            </div>
                ...
                <li class="relative p-6">
                    ...
                    <div class="relative flex justify-center">
                        ...
                        <div class="text-center">
                            <div class="flex flex-col justify-center items-center">
                                <div class="text-gray-600">
                                    <p class="font-bold">Third Party Purchase
                                        Officer
                                    </p>
                                    <p>Albestary Sigalingging</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <li class="relative p-6">
                    ...
                    <div class="relative flex justify-center">
                        ...
                        <div class="text-center">
                            <div class="flex flex-col justify-center items-center">
                                <div class="text-gray-600">
                                    <p class="font-bold">Third Party Grading Officer
                                    </p>
                                    <p>Desi Nurmayani</p>
                                </div>
                            </div>
