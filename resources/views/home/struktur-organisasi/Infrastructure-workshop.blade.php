        ...
        <div class="text-center">
            <div class="flex flex-col justify-center items-center">
                <div class="text-gray-600">
                    <p class="font-bold">Infrastructure & Workshop</p>
                    <p>Department Head</p>
                    <p class="font-semibold">Rudi Anton Sitanggang</p>
                </div>
            </div>
                ...
                <li class="relative p-6">
                    ...
                    <div class="relative flex justify-center">
                        ...
                        <div class="text-center">
                            <div class="flex flex-col justify-center items-center">
                                <div class="text-gray-600">
                                    <p class="font-bold">Infrastructure Officer</p>
                                    <p>Ilham Saputra Suryatmono</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <li class="relative p-6">
                    ...
                    <div class="relative flex justify-center">
                        ...
                        <div class="text-center">
                            <div class="flex flex-col justify-center items-center">
                                <div class="text-gray-600">
                                    <p class="font-bold">Workshop Officer</p>
                                    <p>Raya Lima Marpaung</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <li class="relative p-6">
                    ...
                    <div class="relative flex justify-center">
                        ...
                        <div class="text-center">
                            <div class="flex flex-col justify-center items-center">
                                <div class="text-gray-600">
                                    <p class="font-bold">Traksi Officer</p>
                                    <p>Rahman</p>
                                </div>
                            </div>
                        </div>
