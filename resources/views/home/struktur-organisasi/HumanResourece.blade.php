        ...
        <div class="text-center">
            <div class="flex flex-col justify-center items-center">
                ...
                <div class="text-gray-600">
                    <p class="font-bold">Human Resourece</p>
                    <p>Department Head</p>
                    <p class="font-semibold">Yuda Andriko
                </div>
            </div>
                ...
                <li class="relative p-6">
                    ...
                    <div class="relative flex justify-center">
                        ...
                        <div class="text-center">
                            <div class="flex flex-col justify-center items-center">
                                <div class="text-gray-600">
                                    <p class="font-bold">HR Personalia & IR Officer
                                    </p>
                                    <p>Suhendrik</p>
                                </div>
                            </div>
                ...
                <li class="relative p-6">
                    ...
                    <div class="relative flex justify-center">
                        ...
                        <div class="text-center">
                            <div class="flex flex-col justify-center items-center">
                                <div class="text-gray-600">
                                    <p class="font-bold">HR GA & Transport Officer
                                    </p>
                                    <p>Suriana</p>
                                </div>
                            </div>
