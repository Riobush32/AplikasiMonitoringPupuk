        ...
        <div class="text-center">
            <div class="flex flex-col justify-center items-center">
                ...
                <div class="text-gray-600">
                    <p class="font-bold">QHSE</p>
                    <p>Department Head</p>
                    <p class="font-semibold">Andi Wahyudin</p>
                </div>
            </div>
            <ul class="flex flex-row mt-10 justify-center">
                ...
                <li class="relative p-6">
                    <div class="border-t-2 absolute h-8 border-gray-400 top-0" style="left: 50%; right: 50%;"></div>
                    <div class="relative flex justify-center">
                        <div class="-mt-6 border-l-2 absolute h-6 border-gray-400 top-0">
                        </div>
                        <div class="text-center">
                            <div class="flex flex-col justify-center items-center">
                                <div class="text-gray-600">
                                    <p class="font-bold">QHSE Officer</p>
                                    <p>Mega Khairani</p>
                                </div>
                            </div>
                        </div>
